...
// Fix script for course names and units
// Run with: node scripts/fix-courses-and-units.js
...
async function fixCoursesAndUnits() {
  try {
    ...
    console.log("🔧 Fixing course names...")
    ...
    console.log("📚 Creating units for courses that don't have them...")
    ...
    console.log(`📊 Summary:
    - Updated course names to include level
    - Created ${unitsCreated} new units
    - All courses now have proper units assigned`)
